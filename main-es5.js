(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(activeRoute) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainComponent = /** @class */ (function () {
                function MainComponent(BooksService) {
                ...
                MainComponent.prototype.next = function () {
                    var nextPage = parseInt(this.startIndex, 10) + 20;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WelcomePageComponent = /** @class */ (function () {
                function WelcomePageComponent(route) {
                    this.route = route;
                ...
                WelcomePageComponent.prototype.goToBooks = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WishListComponent = /** @class */ (function () {
                function WishListComponent(BooksService) {
                    this.BooksService = BooksService;
                    this.wishList = [];
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookService = /** @class */ (function () {
                ...
                BookService.prototype.getBooksFromApi = function (q, maxResults, startIndex) {
                    if (!q.trim()) {
                    ...
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseApi, { params: {
                        ...
                        return res.items.map(function (item) { return item.volumeInfo; });
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('countries', [])));
                };
                BookService.prototype.addBookToWishList = function (book) {
                    return this.wishListBooks.push(book);
                };
                BookService.prototype.removeBookFromWishList = function (bookTitle) {
                    var bookIndex = this.wishListBooks.findIndex(function (book) { return book.title === bookTitle; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookComponent = /** @class */ (function () {
                function BookComponent(BooksService) {
                    this.BooksService = BooksService;
                ...
                Object.defineProperty(BookComponent.prototype, "bookImgSrc", {
                    get: function () {
                ...
                BookComponent.prototype.onAddBook = function () {
                    this.BooksService.addBookToWishList(this.book);
                    this.isDialogOpen = false;
                };
                Object.defineProperty(BookComponent.prototype, "checkIfBookInWishList", {
                    get: function () {
                        var _this = this;
                        return this.BooksService.wishListBooks.find(function (bookItem) { return bookItem === _this.book; });
                    },
                    enumerable: true,
                    configurable: true
                });
                BookComponent.prototype.onRemoveBook = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupComponent = /** @class */ (function () {
                ...
                PopupComponent.prototype.clickOutside = function () {
                    this.closeDialog.emit();
                };
                PopupComponent.prototype.addToWishList = function () {
                    this.addBook.emit();
                };
                PopupComponent.prototype.removeFromWishList = function () {
